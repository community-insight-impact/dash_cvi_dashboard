...
sidebar_header = dbc.Row(
    [dbc.Col(html.H2('How to Use the COVID-19 Community Vulnerability Index', className="display-4", style = {'font-size':'25px'})),
        dbc.Col(
            [html.Div(
...
sidebar = html.Div(
    [
        ...
        html.Div(
            [
                html.Hr(),
                html.Div(children= [html.Img(src= 'https://raw.githubusercontent.com/community-insight-impact/covid_community_vulnerability/master/CVI%20Logo%20FINAL%20ONE%20smaller.png'),
                html.P(
                    "This dashboard is part of an open source project designed to effectively understand community needs and allocate resources at the county level.\
